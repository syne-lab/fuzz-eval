...
tbs_str1 = "" \
        ...
        + "00" * (garbage_size + 22 +12)

print("len(tbs_str1) =",len(tbs_str1))
...
S1 = find_atk_prefix(tbs_str1, 2**((garbage_size+22+12)*8))

forged_sig = S1 + S2

print("forged sig =",hex(forged_sig))
